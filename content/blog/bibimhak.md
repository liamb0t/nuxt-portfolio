...
<div style="display: flex; flex-direction: row; align-items: center; justify-content: center; margin-top: 1rem;">
    <figure>
        <img style="width: 50%;" src="/img/bibimhak/bibimhak.png" />
        <figcaption style="text-align:center">Bibimhak is a file-sharing and community platform for ESL teachers in South Korea</figcaption>
    </figure>
</div>
